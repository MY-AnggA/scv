...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $2}')
ipsaya=$(wget -qO- ifconfig.me)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip"
checking_sc() {
...
rm -rf /root/rmbl
echo -e  "${COLOR1}╭══════════════════════════════════════════╮${NC}"
echo -e  "${COLOR1}│  PASWORD SCRIPT MoonVPN     │${NC}"
echo -e  "${COLOR1}╰══════════════════════════════════════════╯${NC}"
echo " "
...
U2=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $6}')
...
madmin=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
