...
IPVPS=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
mkdir /root/casper
cd /root/casper
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip >/dev/null 2>&1
...
LIST=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key | grep $kode | awk '{print $6}')
cd
...
sleep 0.5
rm ipmini
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
res1() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/slowdns/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
res10() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/noobz/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
...
res12() {
wget https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/install/ins-trgo.sh && chmod +x ins-trgo.sh && bash ./ins-trgo.sh
clear
}
...
TIMES="10"
CHATID="5196612474"
KEY="7366465456:AAHolv6q-neV4m8AuLwP_t52c3R7zQJ2SRk"
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/MoonPie-ID/papipu/main/img/moon/MoonVPN/versi  )
